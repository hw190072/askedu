...
(1, 'd', '男', '30', '1990-07-04', '43072419900704113x', '汉族', '未婚', '13019449555', '自由职业', '北京市', '北京市', '东城区', '', NULL, '', '', '', '', '', '', '', '', '0', '', '', 0, 0, 0, NULL, '核准制', '福田外服（窗口）', 'POS机', '个人申报', NULL, '', '窗口集体户', NULL, NULL, 1, NULL, NULL),
(2, '小李', '男', '55', '1965-07-02', '430724196507021110', NULL, '未婚', '13205999999', NULL, '广东省', '广州市', '荔湾区', 'www', NULL, '', '', '', '', '', '', '', '', '0', '', '', 0, 0, 0, NULL, '积分制', '宝安分部（窗口）', '现金', '单位申报', NULL, '', '未知', NULL, NULL, 1, 1593857358, NULL),
(3, '军哥', '女', '20', '2000-07-04', '430724200007041100', NULL, '未婚', '19905999999', '自由职业', '北京市', '北京市', '东城区', '', NULL, '', '', '', '', '', '', '', '', '0', '', '', 0, 0, 0, NULL, '留学生', '南山分部（窗口）', '对公', '单位申报', '无', '', '派出所', NULL, NULL, 1, 1593857888, NULL);
...
--
ALTER TABLE `ask_alldata`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '客户id', AUTO_INCREMENT=4;
