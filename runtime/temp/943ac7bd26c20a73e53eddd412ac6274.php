                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody class="searchall">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" class="artcenter">
                                                        <a href="<?php echo url('alldata/look');; ?>"
                                                            ...
                                                            data-button-index="1" data-original-title="查看"><i
                                                                class="fa fa-eye"></i></a>
                                                        <a href="<?php echo url('alldata/edit','');; ?>"
                                                        class="btn btn-xs btn-danger btn-editone"
                                                        data-toggle="tooltip" title="" data-table-id="table"
                                                        data-field-index="11" data-row-index="0"
                                    ...
                                    <div class="row DTTTFooter">
                                        <div class="col-sm-6">
                                            <div class="dataTables_info" id="simpledatatable_info" role="alert"
                                                aria-live="polite" aria-relevant="all">显示第 0 到第 10 条的记录，总共 100 条记录，每页显示
                                                10 条记录
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
